...
<body>
    ...
    <div class="w-[100%]">
        ...
        <div class="ml-10 mt-10 md:ml-[10%] md:mt-5">
            <span><a href="/pesan1-admin" class="w-10 rounded-lg font-bold md:border-2 md:border-black md:px-5 md:py-[2px]">Dalam Proses</a></span>
            <span><a href="#" class="w-10 underline underline-offset-4 decoration-4 rounded-lg font-bold md:no-underline md:bg-[#929292] md:px-10 md:py-1 md:text-white">Riwayat</a></span>
        </div>
